...
***2. Statistical Inference and Decision Making.*** I formulate new inference and decision problems, such as Bayesian multivariate density-density regression, vertical consensus inference, and random partition summarization with a decision-theoretic approach. I also leverage OT and SOT to improve the scalability and accuracy of statistical estimation in machine learning applications, including generative modeling, representation learning, and domain adaptation.
